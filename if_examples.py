#virtual bartender that serves you if you are of legal age

from random import choice
drinks=["whisky","rum","tequila","gin","sake","wine","beer","vodka","champagne","cognac"]
...
try:
    ...
    age=int(age) #this is where we could have problems
    legal= None
